<div class="sb-onboarding-wizard-step-wrapper sb-onboarding-wizard-step-configuref sb-fs">
	...
	<div class="sb-onboarding-wizard-elements-list sb-fs">
		...
		<div class="sb-onboarding-wizard-elem sb-fs" v-for="feature in onboardingWizardStepContent['configure-features']?.featuresList">
			<div class="sb-onboarding-wizard-elem-info" :data-type="feature?.type">
			...
			<div v-if="feature?.type === undefined" class="sb-onboarding-wizard-elem-toggle">
			...
			<div v-if="feature?.type === 'select'" class="sb-onboarding-wizard-elem-select"  @change.prevent.default="selectOptionOnboardingWizardChange(feature)">
				<select :value="currentOnboardingWizardActiveSettings[feature?.data?.id]?.value">
					<option v-for="(optName, optValue) in feature?.options" :value="optValue">{{optName}}</option>
				</select>
			</div>
		</div>
...
<div class="sb-onboarding-wizard-step-pag-btns sb-fs">
	<button class="sb-btn cff-btn-grey sb-btn-wizard-back" v-html="'Back'" @click.prevent.default="previousWizardStep"></button>
	<button class="sb-btn cff-btn-blue sb-btn-wizard-next" v-html="'Next'" @click.prevent.default="nextWizardStep"></button>
</div>