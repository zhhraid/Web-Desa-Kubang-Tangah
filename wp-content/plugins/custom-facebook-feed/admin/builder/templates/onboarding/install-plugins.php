...
<div class="sb-onboarding-wizard-step-pag-btns sb-fs">
	...
	<button class="sb-btn cff-btn-blue sb-btn-wizard-next sb-btn-wizard-install" v-html="'Install Selected Plugins'" @click.prevent.default="nextWizardStep('submit')"></button>
</div>