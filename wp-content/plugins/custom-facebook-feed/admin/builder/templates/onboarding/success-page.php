<div class="sb-onboarding-wizard-step-wrapper sb-onboarding-wizard-step-success sb-fs">
	...
	<div class="sb-onboarding-wizard-succes-elem sb-fs" v-for="(singleMessage , sId) in onboardingSuccessMessagesDisplay" :style="'transition-delay:' + (parseInt(sId) * .5) + 's;'">
			<span class="sb-onboarding-wizard-succes-icon">
				<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path d="M18.3346 9.23355V10.0002C18.3336 11.7972 17.7517 13.5458 16.6757 14.9851C15.5998 16.4244 14.0874 17.4773 12.3641 17.9868C10.6408 18.4963 8.79902 18.4351 7.11336 17.8124C5.4277 17.1896 3.98851 16.0386 3.01044 14.5311C2.03236 13.0236 1.56779 11.2403 1.68603 9.44714C1.80427 7.65402 2.49897 5.94715 3.66654 4.58111C4.8341 3.21506 6.41196 2.26303 8.16479 1.867C9.91763 1.47097 11.7515 1.65216 13.393 2.38355" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
					<path d="M18.3333 3.33301L10 11.6747L7.5 9.17467"  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
				</svg>
...
<div class="sb-onboarding-wizard-finish-ctn sb-fs">
	<button class="sb-btn sb-btn-grey"  @click.prevent.default="dismissOnboardingWizard">
		...
		<svg width="6" height="9" viewBox="0 0 6 9" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.66656 0.5L0.726562 1.44L3.7799 4.5L0.726562 7.56L1.66656 8.5L5.66656 4.5L1.66656 0.5Z" fill="#141B38"/></svg>
	</button>
</div>
