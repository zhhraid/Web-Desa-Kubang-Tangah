  ...
  var app = {
    ...
    jqueryInit: function jqueryInit($) {
      ...
      $(document).on('click', "#sby-recheck-license-key", function () {
        ...
        var sbyLicenseNotice = $('#sby-license-notice');
        $.ajax({
      ...
      $(document).on('click', "#sby-hide-notice", function () {
        var sbyLicenseNotice = $('#sby-license-notice');
        var sbyLicenseModal = $('.sby-sb-modal');
      ...
      $('body').on('click', '#sby_review_consent_yes', function (e) {
        var reviewStep1 = $('.sby_review_notice_step_1, .sby_review_step1_notice');
        var reviewStep2 = $('.sby_notice.sby_review_notice, .rn_step_2');
        reviewStep1.hide();
        reviewStep2.show();
        $.ajax({
          url: sby_admin.ajax_url,
      ...
      $('body').on('click', '#sby_review_consent_no', function (e) {
        var reviewStep1 = $('.sby_review_notice_step_1, #sby-notifications');
        reviewStep1.hide();
        $.ajax({
          url: sby_admin.ajax_url,
          type: 'post',
     ...
     * @since 2.18
     */
    buttonDismiss: function buttonDismiss(event) {
     ...
     * @param {object} event Event object.
     */
    navNext: function navNext(event) {
     ...
     * @param {object} event Event object.
     */
    navPrev: function navPrev(event) {
