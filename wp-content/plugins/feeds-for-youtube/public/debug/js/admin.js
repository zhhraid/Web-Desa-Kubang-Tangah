...
(function ($) {
  ...
  SbspfAdmin.prototype = {
    ...
    addAccessTokenListener: function addAccessTokenListener() {
      var self = this;
    ...
    initClickRemove: function initClickRemove(el) {
      var self = this;
    ...
    initInfoToggle: function initInfoToggle(el) {
      var self = this;
    ...
    initAppCredToggle: function initAppCredToggle() {
      var self = this;
    ...
    initWidthResponsiveToggle: function initWidthResponsiveToggle() {
      //Mobile width
    ...
    addManualAccessTokenListener: function addManualAccessTokenListener() {
      var self = this,
        id = "#" + this.plugin,
        cla = "." + this.plugin;
    ...
    afterConnectedAccountRemoved: function afterConnectedAccountRemoved(accountID) {},
    updateLayoutOptionsDisplay: function updateLayoutOptionsDisplay() {
      self = this;
      setTimeout(function () {
    ...
    updateBoxSelectionDisplay: function updateBoxSelectionDisplay() {
      self = this;
      setTimeout(function () {
    ...
    updateFeedWidthDisplay: function updateFeedWidthDisplay() {
      self = this;
    ...
    updateOnSelect: function updateOnSelect($changed) {
  ...
  function SBImporter() {
    ...
    this.spinner = '<svg class="svg-inline--fa fa-spinner fa-w-16 fa-pulse" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="spinner" role="presentation" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M304 48c0 26.51-21.49 48-48 48s-48-21.49-48-48 21.49-48 48-48 48 21.49 48 48zm-48 368c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.49-48-48-48zm208-208c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.49-48-48-48zM96 256c0-26.51-21.49-48-48-48S0 229.49 0 256s21.49 48 48 48 48-21.49 48-48zm12.922 99.078c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48c0-26.509-21.491-48-48-48zm294.156 0c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48c0-26.509-21.49-48-48-48zM108.922 60.922c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.491-48-48-48z"></path></svg>';
  }
  SBImporter.prototype = {
    ...
    updateHTML: function updateHTML(continueLoading) {
      if (continueLoading) {
        $(".sby_remaining").text(sbImporter.numNeeded);
      } else {
    ...
    doImportBatch: function doImportBatch() {
      ...
      var onSuccess = function onSuccess(data) {
        if (data.indexOf("{") > -1) {
          ...
          if (response.num_retrieved > 0 && sbImporter.numNeeded > 0 && sbImporter.remainingCycles > 0 && response.next.length > 1) {
