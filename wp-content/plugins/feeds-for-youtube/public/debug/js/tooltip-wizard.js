...
var SBYTooltipWizard = window.SBYTooltipWizard || function (document, window, $) {
  ...
  var app = {
    ...
    waitForInserterButton: function waitForInserterButton(callback, attempts) {
      attempts = attempts || 0;
      var maxAttempts = 20;
      ...
      if (attempts < maxAttempts) {
        ...
        console.error('SBYTooltipWizard: Inserter button not found after ' + maxAttempts + ' attempts.');
      }
    },
    initGutenbergTooltip: function initGutenbergTooltip() {
     ...
     */
    isGutenberg: function isGutenberg() {
...
/******/ })()
;
//# sourceMappingURL=tooltip-wizard.js.map