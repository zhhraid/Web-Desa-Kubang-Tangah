...
var SbElementorHandler = window.SbElementorHandler || function (_document, window, $) {
  var smashBalloonPlugins = sbHandler.smashPlugins;
  var app = {
    init: function init() {
      app.events();
    },
    ...
    disableInactiveSmashWidgets: function disableInactiveSmashWidgets() {
      setTimeout(function () {
        var _loop = function _loop(pluginName) {
          var plugin = smashBalloonPlugins[pluginName],
        ...
        for (var pluginName in smashBalloonPlugins) {
          _loop(pluginName);
        }
      }, 500);
    },
    createUpsellPopup: function createUpsellPopup(pluginName) {
      var plugin = smashBalloonPlugins[pluginName],
        ...
        upsellPopupOutput = '<div class="sb-source-ctn sb-fs-boss sb-center-boss">\
      ...
      $(window.parent.document.body).find('.sb-install-plugin-btn').on('click', function () {
        var downloadPlugin = $(this).attr('data-plugin');
    ...
    closeUpsellPopup: function closeUpsellPopup() {
      $(window.parent.document.body).find('.sb-center-boss').remove();
    },
    installPlugin: function installPlugin(downloadPlugin) {
