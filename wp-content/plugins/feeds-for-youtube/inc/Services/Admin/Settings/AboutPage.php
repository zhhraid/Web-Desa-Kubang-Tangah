	...
	public function filter_settings_object( $settings ) {
		...
		$settings['pluginInfo'] = [
			...
			'feed_analytics'   => array(
				...
				'permalink'   => sprintf( 'https://smashballoon.com/feed-analytics/?edd_license_key=%s&upgrade=true&utm_campaign='. sby_utm_campaign() .'&utm_source=about&utm_medium=feed-analytics', $license_key ),
				'permalink_text' => __( 'See Demo', 'feeds-for-youtube' ),
				'installed'       => isset( $sb_other_plugins['is_feed_analytics_installed'] ) && $sb_other_plugins['is_feed_analytics_installed'] == true,
				'activated'       => is_plugin_active( $sb_other_plugins['feed_analytics_plugin'] ),
			),
