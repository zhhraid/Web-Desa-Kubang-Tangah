...
use SmashBalloon\Reviews\Vendor\DI\Annotation\Injectable;
...
use SmashBalloon\Reviews\Vendor\Doctrine\Common\Annotations\AnnotationRegistry;
use SmashBalloon\Reviews\Vendor\Doctrine\Common\Annotations\Reader;
use SmashBalloon\Reviews\Vendor\Doctrine\Common\Annotations\SimpleAnnotationReader;
...
class AnnotationBasedAutowiring implements DefinitionSource, Autowiring
{
    ...
    public function getAnnotationReader()
    {
        if ($this->annotationReader === null) {
            ...
            $this->annotationReader->addNamespace('SmashBalloon\\Reviews\\Vendor\\DI\\Annotation');
        }
    ...
    private function readInjectableAnnotation(ReflectionClass $class, ObjectDefinition $definition)
    {
        try {
            ...
            $annotation = $this->getAnnotationReader()->getClassAnnotation($class, 'SmashBalloon\\Reviews\\Vendor\\DI\\Annotation\\Injectable');
