...
class Feed_Builder extends ServiceProvider
{
    ...
    public function register_menu()
    {
        ...
        $feed_builder = add_submenu_page($this->menu['parent_menu_slug'], $this->menu['page_title'], $this->menu['menu_title'], $cap, $this->menu['menu_slug'], [$this, 'feed_cutomizer_output'], 0);
     ...
     * @since 1.0
     */
    public static function enqueue_date_i18n()
    {
        global $wp_locale;
