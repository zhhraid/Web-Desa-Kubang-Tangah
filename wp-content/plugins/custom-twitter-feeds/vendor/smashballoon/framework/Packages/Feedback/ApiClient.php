 ...
 * @package Feedback
 */
namespace Smashballoon\TwitterFeed\Vendor\Smashballoon\Framework\Packages\Feedback;
...
class ApiClient
{
    ...
    public static function is_dev_environment()
    {
        ...
        if (function_exists('Smashballoon\TwitterFeed\Vendor\wp_get_environment_type')) {
